...
<div class="container">
<%
    String bidderParam = request.getParameter("bidder_name");
    String searchBidder = (bidderParam != null) ? bidderParam : "";
%>
    <h2>Q7: 모든 입찰 기록과 입찰자명 조회 (3중 조인)</h2>
...
<%
    ...
    String sql = "SELECT A.AuctionID, I.Name AS ItemName, U.Name AS BidderName, B.BidAmount, B.BidTime "
...
%>
            <tr>
                ...
                <td style="font-weight:bold; color:#fff;"><%= rs.getString("BidderName") %></td>
                <td style="color:#28a745;"><%= rs.getLong("BidAmount") %> G</td>
                <td style="color:#aaa; font-size:0.9rem;"><%= rs.getTimestamp("BidTime") %></td>
            </tr>
<%
        }
    } catch (Exception e) {
