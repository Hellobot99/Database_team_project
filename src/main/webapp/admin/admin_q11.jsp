...
<head>
<meta charset="UTF-8">
<title>Q11: 가장 비싼 물품 TOP 5</title>
...
<style>
    ...
    .rank-1 { color: #ffcc00; font-weight: bold; font-size: 1.1rem; }
...
<body>
<div class="container">
    <h2>Q11: 가장 비싼 물품 TOP 5 (기본 가격 기준)</h2>
...
<%
    ...
    String sql = "SELECT * FROM ( "
               + "  SELECT I.ItemID, I.Name, C.Name AS CategoryName, I.BasePrice "
               + "  FROM ITEM I "
...
%>
            <tr>
                ...
                <td style="color: #28a745; font-weight: bold;"><%= rs.getLong("BasePrice") %> G</td>
            </tr>
<%
        }
    } catch (Exception e) {
