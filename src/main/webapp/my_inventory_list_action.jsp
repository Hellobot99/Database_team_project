...
%>
	    <form method="POST" action="my_inventory_list_action.jsp">
	        ...
	        Start Price: <input type="text" name="start_price"><br>
	        End Time : After 7 days<br>
...
if ("step2".equals(mode)) {
    ...
    try {
        ...
        String selectAuctionId =
                "select auctionID from Auction where rownum = 1 order by auctionid desc";
        ...
        String insertAuctionSql =
            "insert into auction (auctionid, start_price, StartTime, EndTime, CurrentHighestPrice, ItemID, SellerID, REGISTERINVENTORYID) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        String updateInvSql =
            "UPDATE INVENTORY SET quantity = quantity - 1 WHERE inventoryid = ?";
